 ...
 * @author TYY
 * @ClassName: SPUtil
 * @Description: 程中从此用这个类处理SharedPreferences 且此类有保存对象和读取对象的功能
 * @date 2015年9月8日 上午10:11:21
 */
public class SPUtil {

    public static String PREFERENCE_NAME = "tany";
    public static String PREFERENCE_OBJECT_NAME = "tany_obj";

    public static void setName(String name, String objName) {
        PREFERENCE_NAME = name;
        PREFERENCE_OBJECT_NAME = objName;
    }
    ...
    public static void put(String key, Object o) {
        ...
        putString(BaseActivity.getActivity(), key, s);
    }

    public static Object get(String key, Class beanClass) {
        return JSONToObject(getString(BaseActivity.getActivity(), key), beanClass);
    }
    ...
    public static boolean putDouble(Context context, String key, float value) {
        SharedPreferences settings = context.getSharedPreferences(
                PREFERENCE_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = settings.edit();
     ...
     * @Description: 添加byte
     */
    public static void putBytes(Context context, String key, byte[] bytes) {
        try {
            SharedPreferences settings = context.getSharedPreferences(
                    PREFERENCE_NAME, Context.MODE_PRIVATE);
            SharedPreferences.Editor editor = settings.edit();
            editor.putString(key, new String(bytes, "ISO-8859-1")).commit();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static boolean removeObj(Context context, String key) {
        try {
            SharedPreferences settings = context.getSharedPreferences(PREFERENCE_OBJECT_NAME, Context.MODE_PRIVATE);
            SharedPreferences.Editor editor = settings.edit();
            editor.remove(key);
            editor.commit();
            return true;
