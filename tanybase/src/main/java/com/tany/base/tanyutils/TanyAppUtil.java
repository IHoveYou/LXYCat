...
public class TanyAppUtil {
    ...
    public static void installApp(Context context, String filePath) {
        context.startActivity(TanyIntentUtil.getInstallAppIntent(context, filePath));
    }
    ...
    public static void installApp(Context context, File file) {
        if (!TanyFileUtil.isFileExists(file)) return;
    ...
    public static void installApp(Activity activity, String filePath, int requestCode) {
        activity.startActivityForResult(TanyIntentUtil.getInstallAppIntent(activity, filePath), requestCode);
    }
    ...
    public static boolean installAppSilent(Context context, String filePath) {
        File file = TanyFileUtil.getFileByPath(filePath);
        if (!TanyFileUtil.isFileExists(file)) return false;
        String command = "LD_LIBRARY_PATH=/vendor/lib:/system/lib pm install " + filePath;
        TanyShellUtil.CommandResult commandResult = TanyShellUtil.execCmd(command, !isSystemApp(context), true);
    ...
    public static boolean isSystemApp(Context context, String packageName) {
        if (TanyDataUtil.isNullString(packageName)) return false;
        try {
    ...
    public static void uninstallApp(Context context, String packageName) {
        if (TanyDataUtil.isNullString(packageName)) return;
        context.startActivity(TanyIntentUtil.getUninstallAppIntent(packageName));
    }
    ...
    public static void uninstallApp(Activity activity, String packageName, int requestCode) {
        if (TanyDataUtil.isNullString(packageName)) return;
        activity.startActivityForResult(TanyIntentUtil.getUninstallAppIntent(packageName), requestCode);
    }
    ...
    public static boolean isAppRoot() {
        TanyShellUtil.CommandResult result = TanyShellUtil.execCmd("echo root", true);
        if (result.result == 0) {
            return true;
        }
    ...
    public static void launchApp(Context context, String packageName) {
        if (TanyDataUtil.isNullString(packageName)) return;
        context.startActivity(TanyIntentUtil.getLaunchAppIntent(context, packageName));
    }
    ...
    public static void launchApp(Activity activity, String packageName, int requestCode) {
        if (TanyDataUtil.isNullString(packageName)) return;
        activity.startActivityForResult(TanyIntentUtil.getLaunchAppIntent(activity, packageName), requestCode);
    }
    ...
    public static void getAppDetailsSettings(Context context, String packageName) {
        if (TanyDataUtil.isNullString(packageName)) return;
        context.startActivity(TanyIntentUtil.getAppDetailsSettingsIntent(packageName));
    }
    ...
    public static String getAppName(Context context, String packageName) {
        if (TanyDataUtil.isNullString(packageName)) return null;
        try {
            PackageManager pm = context.getPackageManager();
    ...
    public static int getAppVersionCode(Context context, String packageName) {
        if (TanyDataUtil.isNullString(packageName)) return -1;
        try {
            PackageManager pm = context.getPackageManager();
            PackageInfo pi = pm.getPackageInfo(packageName, 0);
    ...
    public static String getAppSignatureSHA1(Context context, String packageName) {
        ...
        return TanyEncryptUtil.encryptSHA1ToString(signature[0].toByteArray()).
    ...
    public static boolean isAppForeground(Context context, String packageName) {
        return !TanyDataUtil.isNullString(packageName) && packageName.equals(TanyProcessUtil.getForegroundProcessName(context));
    }
    //----------------------------------------------------------------------------------------------------------------
    ...
    public static boolean isInstallApp(Context context, String packageName) {
        return !TanyDataUtil.isNullString(packageName) && TanyIntentUtil.getLaunchAppIntent(context, packageName) != null;
    }
    ...
    public static boolean cleanAppData(Context context, File... dirs) {
        boolean isSuccess = TanyFileUtil.cleanInternalCache(context);
        isSuccess &= TanyFileUtil.cleanInternalDbs(context);
        isSuccess &= TanyFileUtil.cleanInternalSP(context);
        isSuccess &= TanyFileUtil.cleanInternalFiles(context);
        isSuccess &= TanyFileUtil.cleanExternalCache(context);
        for (File dir : dirs) {
            isSuccess &= TanyFileUtil.cleanCustomCache(dir);
        }
        return isSuccess;
    }
