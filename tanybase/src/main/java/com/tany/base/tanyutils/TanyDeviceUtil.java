...
public class TanyDeviceUtil {
    ...
    public static void callPhone(final Context context, String phoneNumber) {
        if (!TanyDataUtil.isNullString(phoneNumber)) {
    ...
    public static void sendSms(Context context, String phoneNumber, String content) {
        Uri uri = Uri.parse("smsto:" + (TanyDataUtil.isNullString(phoneNumber) ? "" : phoneNumber));
        Intent intent = new Intent(Intent.ACTION_SENDTO, uri);
        intent.putExtra("sms_body", TanyDataUtil.isNullString(content) ? "" : content);
    ...
    public static List<HashMap<String, String>> getAllContactInfo(Context context) {
        ...
        while (cursor.moveToNext()) {
            ...
            // 判断contact_id是否为空
            if (!TanyDataUtil.isNullString(contact_id)) {//null   ""
    ...
    public static Bitmap captureWithoutStatusBar(Activity activity) {
        ...
        view.buildDrawingCache();
        Bitmap bmp = view.getDrawingCache();
        int statusBarHeight = TanyBarUtil.getStatusBarHeight(activity);
        int width = getScreenWidth(activity);
        int height = getScreenHeight(activity);
