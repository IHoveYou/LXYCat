...
public class TanyTextViewVertical extends TextSwitcher implements ViewSwitcher.ViewFactory {
    ...
    public TanyTextViewVertical(Context context) {
        this(context, null);
        mContext = context;
    }

    public TanyTextViewVertical(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
