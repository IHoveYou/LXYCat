...
public class CountDownButton extends Button {
    ...
    public CountDownButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //设置默认背景色
        normalColor = typedArray.getColor(R.styleable.CountDownButton_normalColor,android.R.color.transparent);
        //设置默认倒计时 背景色
        ...
        countDownTimer = new CountDownTimer(millisinfuture, countdowninterva) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                setText((Math.round((double) millisUntilFinished / 1000) - 1) + "s后重发");
